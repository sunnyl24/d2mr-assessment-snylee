...
numeric_cols <- c("mpg", "cyl", "disp", "hp", "drat", "wt", "qsec", "vs", "am", "gear", "carb")
clean.mtcars[numeric_cols] <- lapply(clean.mtcars[numeric_cols], as.numeric)
...
<!-- answer below -->
There are NA values in some of the columns that I need to get rid of. 
Reduce down to consistent decimal points. 
Mtcars is a data.frame and clean.mtcars is a tibble
Mtcars rowname is character while clean.mtcars is a numeric
...
render_diff(clean.mtcars,mtcars)
diff_data(mtcars, clean.mtcars)

class(mtcars)
class(clean.mtcars)

clean.mtcars <- as.data.frame(clean.mtcars)
...
I find the diff_data more helpful at this point because it does direct comparison between two elements in my dataframe. 
...
class(clean.mtcars$mpg)
class(clean.mtcars$cyl)
class(clean.mtcars$disp)
class(clean.mtcars$hp)
class(clean.mtcars$drat)
class(clean.mtcars$wt)
class(clean.mtcars$qsec)
class(clean.mtcars$vs)
class(clean.mtcars$am)

#All numeric, so we can't remove whitespace
```
...
any(is.na(clean.mtcars$mpg))
any(is.na(clean.mtcars$cyl))
any(is.na(clean.mtcars$hp))

clean.mtcars[is.na(clean.mtcars$cyl), ]
clean.mtcars[is.na(clean.mtcars$hp), ]
...
clean.mtcars[9, "hp"] <- 95
clean.mtcars[18, "hp"] <- 66
clean.mtcars[27, "hp"] <- 91
clean.mtcars[15, "cyl"] <- 8
clean.mtcars[30, "cyl"] <- 6
