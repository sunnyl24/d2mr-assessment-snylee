...
#trim white space #don't repair column names, changes are minimal #column types are default, this prevents R from guessing columns 

# Inspect the data using head(), str(), and glimpse()
# Notice the differences in the information you get with each
head(messy.iris) #checks first six rows of the data 
str(messy.iris) #shows the structure of the data 
glimpse(messy.iris) #from the dplyr package, and provides a more readable summary than str
...
clean.iris <- messy.iris %>% # %>% is a pipe function
